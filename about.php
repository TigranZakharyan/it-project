<?php 
  ...
  $q1 = $DB -> query("SELECT * FROM about WHERE id='1'");
  $q2 = $DB -> query("SELECT * FROM about WHERE id='2'");
  $q3 = $DB -> query("SELECT * FROM about WHERE id='3'");
  $q4 = $DB -> query("SELECT * FROM about WHERE id='4'");
  $q5 = $DB -> query("SELECT * FROM about WHERE id='5'");
  $q6 = $DB -> query("SELECT * FROM about WHERE id='6'");
  $q7 = $DB -> query("SELECT * FROM about WHERE id='7'");
  $q8 = $DB -> query("SELECT * FROM about WHERE id='8'");
  $q9 = $DB -> query("SELECT * FROM about WHERE id='9'");
  $q10 = $DB -> query("SELECT * FROM about WHERE id='10'");
  
  $arr1 = mysqli_fetch_assoc($q1);
  $arr2 = mysqli_fetch_assoc($q2);
  $arr3 = mysqli_fetch_assoc($q3);
  $arr4 = mysqli_fetch_assoc($q4);
  $arr5 = mysqli_fetch_assoc($q5);
  $arr6 = mysqli_fetch_assoc($q6);
  $arr7 = mysqli_fetch_assoc($q7);
  $arr8 = mysqli_fetch_assoc($q8);
  $arr9 = mysqli_fetch_assoc($q9);
  $arr10 = mysqli_fetch_assoc($q10);
?>
      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h2><?=$arr1[$lang.'_text']?></h2>
            <p class="large"><?=$arr2[$lang.'_text']?></p>
          </div>
        </div>
      </div>
    </div>
    <div class="row about_blog">
      <div class="col-lg-6 col-md-6 col-sm-12 about_cont_blog">
        <div class="full text_align_left">
          <h3><?=$arr3[$lang.'_text']?></h3>
          <p><?=$arr4[$lang.'_text']?></p>
          <ul>
            <li><i class="fa fa-check-circle"></i><?=$arr5[$lang.'_text']?></li>
            <li><i class="fa fa-check-circle"></i><?=$arr6[$lang.'_text']?></li>
            <li><i class="fa fa-check-circle"></i><?=$arr7[$lang.'_text']?></li>
          </ul>
        </div>
      </div>
    ...
    <div class="row" style="margin-top: 35px">
      ...
      <div class="col-md-4">
        <div class="full" style="margin-top: 35px;">
          <h3><?=$arr8[$lang.'_text']?></h3>
          <p><?=$arr9[$lang.'_text']?></p>
          <p><a class="btn main_bt" href="#"><?=$arr10[$lang.'_text']?></a></p>
        </div>
      </div>
    </div>
  </div>
